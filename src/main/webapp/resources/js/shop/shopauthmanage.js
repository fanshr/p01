$(function() {
    var shopId = 1;
    var listUrl = '/p01/shop/listshopauthmapsbyshop?pageIndex=1&pageSize=9999&shopId=' + shopId;
    var deleteUrl = '/p01/shop/removeshopauthmap';
    ...
    $('.shopauth-wrap').on('click', 'a', function (e) {
        ...
        if (target.hasClass('edit')) {
            window.location.href = '/p01/shop/shopauthedit?shopauthId=' + e.currentTarget.dataset.authId;
    ...
    // $('#new').click(function () {
    //     window.location.href = '/p01/shop/shopauthedit';
    // });
});